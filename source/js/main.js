...
const addZero = (element) => element > 10 ? element : `0${element}`;

// Функция, которая возвращает время в необходимом формате
...
const toDrawCurrentChart = () => {
  setTimeout(() => {
    ...
    const toChangeViewOfAxises = (axisX, axisY, axisColor, axisWidth, axisDasharray = 'none') => {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  buttonYesterday.textContent = formattedYesterdayDate;
  //toDrawChart(DATA_TIME, dataCallsToday, 'workload__chart-chart-today');
});
